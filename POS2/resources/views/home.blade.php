...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(135deg, #83a4d4, #6a11cb); /* Biru muda ke ungu */
            display: flex;
        ...
        .category-btn:hover {
            background-color: #5a0db3; /* Warna ungu lebih gelap */
        }
    ...
    <div class="container">
        ...
        <div class="products">
            ...
            <<div class="product-card">
                ...
                <h4>Kerastase Bain 500ml Anti Dandruff Shampoo</h4>
                <p>Rp 100.000</p>
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="{{ asset('image/Teh.png') }}" alt="Teh" class="product-image">
