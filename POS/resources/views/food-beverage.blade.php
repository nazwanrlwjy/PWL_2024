...
<body>
    ...
    <div class="product-grid">
        ...
        <div class="product-card">
            <img src="https://id.pinterest.com/pin/886083295443442077/" alt="Product 1" class="product-image">
        ...
        <!-- Product 2 -->
        <div class="product-card">
            <img src="https://via.placeholder.com/200x150" alt="Product 2" class="product-image">
            <div class="product-info">
                <h3>Produk B</h3>
                <p>Rp 15.000</p>
            </div>
        ...
        <!-- Product 3 -->
        <div class="product-card">
            <img src="https://via.placeholder.com/200x150" alt="Product 3" class="product-image">
            <div class="product-info">
                <h3>Produk C</h3>
                <p>Rp 30.000</p>
            </div>
