    ...
    <div class="container">
        ...
        <div class="products">
            ...
            <div class="product-card">
                <img src="{{ asset('image/shampoBaby.jpg') }}" alt="Teh" class="product-image">                
                <h4>My Baby Shampoo 100ml - Rambut Bayi Hitam dan Bersinar | Junior Babyshop1</h4>
                <p>Rp11.500</p>
            ...
            <!-- Product 2 -->
            <div class="product-card">
                <img src="{{ asset('image/susuAnak.jpg') }}" alt="Teh" class="product-image">
                <h4>Nutren Junior Vanila 400 gram</h4>
                <p>Rp163.000</p>
                <button class="btn">+ Keranjang</button>
                <button class="btn">Beli</button>
            </div>
            ...
            <!-- Product 3 -->
            <div class="product-card">
                <img src="{{ asset('image/baju.jpg') }}" alt="Baju" class="product-image">
                <h4>One Set Anak</h4>
                <p>Rp92.000</p>
                <button class="btn">+ Keranjang</button>
                <button class="btn">Beli</button>
            ...
            <!-- Product 4 -->
            <div class="product-card">
                <img src="{{ asset('image/botolSusu.jpg') }}" alt="Teh" class="product-image">
                <h4>Preferred Dot Bayi Botol Susu丨180Ml/330Ml Botol Minum Bayi BPA Free Baby Botol Susu PBB16</h4>
                <p>Rp31.501</p>
                <button class="btn">+ Keranjang</button>
                <button class="btn">Beli</button>
            </div>
